...
export const createProject = async (req, res) => {
    try {
        ...
        return res.status(200).json({ nombre, fecha_inicio, fecha_fin_estimado, fecha_fin, estado, horas_reales, descripción, project_manager, id_cliente, id: result.insertId});
    } catch (error) {
